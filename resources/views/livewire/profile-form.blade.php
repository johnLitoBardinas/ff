<div>
    <form method="POST" wire:submit.prevent="profileSubmit">
        ...
        <div class="d-flex justify-content-end">
            <button type="submit" class="btn btn-sm btn-default border mr-2 btn__ff--primary btn-icon btn-icon__save">SAVE</button>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control border-primary @error('firstName') is-invalid @enderror" aria-describedby="firstName" placeholder="Enter FirstName" wire:model="firstName" />
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control border-primary @error('lastName') is-invalid @enderror" aria-describedby="firstName" placeholder="Enter LastName" wire:model="lastName" />
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control border-primary @error('mobileNumber') is-invalid @enderror" aria-describedby="firstName" placeholder="Enter MobileNumber" wire:model="mobileNumber" />

<div class="container mt-4 container--new-customer">
        ...
        <div class="form-group">
            ...
            <select class="custom-select border-primary" name="package_id" required>
                @forelse ($subscriptionPlans as $plan)
                    <option value="{{$plan['package_id']}}">{{ucfirst($plan['package_name'])}}</option>
                @empty
    ...
    <div class="d-flex justify-content-between">
        ...
        <button class="btn btn-sm btn-default border mr-2 btn__ff--primary btn-icon btn-icon__save d-flex" id="btn-save-new-customer">ADD CUSTOMER</button>
    </div>
</div>

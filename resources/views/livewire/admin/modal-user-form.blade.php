<div class="modal fade" id="modal-user-form" tabindex="-1" role="dialog" aria-labelledby="ModalUserForm" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <h5 class="modal-title" id="ModalUserForm">Add User to <u><b>{{$branchName}}</b></u></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form method="POST" id="frm-branch-users">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="mobile-number" name="mobile_number" placeholder="Mobile Number">
            </div>
            <div class="form-group">
              <label for="message-text" class="col-form-label">Role:</label>
              <select name="role_id" id="role-id" class="form-control w-50">

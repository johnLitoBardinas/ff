        ...
        <div class="card mb-3 branch" >
            <div class="card-header d-flex justify-content-between align-items-center cursor-pointer"
                ...
                <div class="w-10 d-flex">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20.51" height="13.821" viewBox="0 0 20.51 13.821" fill="{{$branch->branch_id === $activeBranchId ? 'white' : '#463291'}}">
                        @if ($branch->branch_type === 'salon')
                        <path

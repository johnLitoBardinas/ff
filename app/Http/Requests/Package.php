...
class Package extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'salon_days_valid_count' => ['required', 'max:60', 'min:5', 'integer'],
            'gym_no_of_visits' => ['required', 'max:4', 'min:0', 'integer'],
            'gym_days_valid_count' => ['required', 'max:60', 'min:5', 'integer'],
            'spa_no_of_visits' => ['required', 'max:4', 'min:1', 'integer'],
            'spa_days_valid_count' => ['required', 'max:60', 'min:5', 'integer'],
        ];
    }
